...
let
  ...
  suffix = {
    x86_64-linux = "dbru.zip";
    aarch64-linux = "dbru.zip";
    x86_64-darwin = "dbru.zip";
    aarch64-darwin = ".dmg";
  }.${stdenv.hostPlatform.system} or throwSystem;
  ...
  srcs = map
    (component:
      (fetcher (srcFilename component arch version rels.${component} suffix.${component} or "") hashes.${component} or ""))
    components;
